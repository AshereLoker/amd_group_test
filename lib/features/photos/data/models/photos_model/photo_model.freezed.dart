...
class _$_PhotoModel implements _PhotoModel {
  ...
  @override
  String toString() {
    return 'PhotoModel(id: $id, width: $width, height: $height, url: $url, photographer: $photographer, photographerUrl: $photographerUrl, photographerId: $photographerId, src: $src, avgColor: $avgColor, liked: $liked, alt: $alt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, width, height, url,
      photographer, photographerUrl, photographerId, src, avgColor, liked, alt);
