...
class _$_Photo implements _Photo {
  ...
  @override
  String toString() {
    return 'Photo(id: $id, width: $width, height: $height, url: $url, photographer: $photographer, photographerUrl: $photographerUrl, photographerId: $photographerId, src: $src, avgColor: $avgColor, liked: $liked, alt: $alt)';
  }
